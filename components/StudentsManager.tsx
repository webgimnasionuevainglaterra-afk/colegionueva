        ...
        <CreateEstudianteModal
          ...
          onEstudianteCreated={(cursoId) => {
            ...
            if (cursoId) {
              ...
              // Si no se asignó a un curso, recargar la lista de cursos
              fetchCourses();
            }
          }}
        />
...
function CreateEstudianteModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Estudiante creado exitosamente' + (cursoSeleccionado ? ' y asignado al curso' : ' (sin asignar a curso)'));
      ...
      <div className="modal-container" style={{ maxWidth: '600px', maxHeight: '90vh', overflowY: 'auto', zIndex: 2001 }} onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="modal-body">
          <div className="form-group">
            ...
            >
              <option value="">Sin asignar a curso (opcional)</option>
              {cursos.map((curso) => (
